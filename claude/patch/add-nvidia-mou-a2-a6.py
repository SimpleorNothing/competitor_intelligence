...
'26.8.15 판단 반영
  ...
  - 모빌리티(AIDV): 스코프 밖, 별도 축·태그 없이 A6 MOU 항목 interpretation 내 맥락 주석으로만 기록
...
NEW_ITEMS = [
    {
        ...
        "interpretation": (
            ...
            "[스코프 주석 '26.8.15] 동일 MOU의 세 번째 축인 모빌리티(엔비디아 드라이브 하이페리온 기반 "
            "AI 정의 차량 AIDV용 고성능 컴퓨팅 플랫폼을 개발해 완성차 OEM에 공급)는 LG전자 VS 영역으로 "
            "본 보드(HS·ES 중심 6축) 스코프 밖 — 별도 축 신설·태그 부착 없이 맥락으로만 기록"
        ),
        "signalType": "Insight",
        "confidence": "사실",
    ...
    },
    {
        ...
        "interpretation": (
            ...
            "구매 보증이 아니다. 매출 인식은 실제 수주·납품 시점부터 — 이 때문에 '26.8.15 판단으로 "
            "trajGrade 는 behind 유지. "
